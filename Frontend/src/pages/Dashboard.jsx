    ...
    <main className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-6">
      ...
      <div className="mb-6">
        ...
        <p className="text-sm text-gray-500 mt-1">
          Comprehensive analysis of Nepal House of Representatives Election
          2082 BS
        </p>
      </div>
      ...
      {loading ? (
        ...
        <>
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4 mb-8">
            ...
            <StatCard
              title="Average Age"
              value={`${overview?.averageAge || 0} yrs`}
          ...
          {overview?.topCandidate && (
            <div className="mb-8 bg-linear-to-r from-red-50 via-rose-50 to-blue-50 border border-red-200 rounded-xl p-5">
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-6 mb-6">
            ...
            <VoteSharePieChart data={partyStats} />
          </div>
